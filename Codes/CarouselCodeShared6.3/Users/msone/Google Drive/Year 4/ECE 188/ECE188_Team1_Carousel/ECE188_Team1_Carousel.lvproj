...
<Project Type="Project" LVVersion="17008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="motorTest.vi" Type="VI" URL="../motorTest.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Buzzer SubVI.vi" Type="VI" URL="../../SubVIs/Buzzer SubVI.vi"/>
			<Item Name="LCD(SubVI).vi" Type="VI" URL="../../SubVIs/LCD(SubVI).vi"/>
			<Item Name="MotorPWM(SubVI).vi" Type="VI" URL="../../SubVIs/MotorPWM(SubVI).vi"/>
			<Item Name="MotorPWM_B(SubVI).vi" Type="VI" URL="../../SubVIs/MotorPWM_B(SubVI).vi"/>
			<Item Name="NiFpgaLv.dll" Type="Document" URL="NiFpgaLv.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="sevensegment(SubVI).vi" Type="VI" URL="../../SubVIs/sevensegment(SubVI).vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build"/>
	</Item>
	<Item Name="NI-myRIO-1900-0304a72b-16" Type="RT myRIO">
		<Property Name="alias.name" Type="Str">NI-myRIO-1900-0304a72b-16</Property>
...
AddOutputFilter chunkFilter
		...
		<Item Name="SubVIs" Type="Folder">
			<Item Name="Buzzer SubVI.vi" Type="VI" URL="../../SubVIs/Buzzer SubVI.vi"/>
			<Item Name="Encoder(SubVI).vi" Type="VI" URL="../../SubVIs/Encoder(SubVI).vi"/>
			<Item Name="encoderposition(SubVI).vi" Type="VI" URL="../../SubVIs/encoderposition(SubVI).vi"/>
			<Item Name="HSVtoRGB.vi" Type="VI" URL="../../SubVIs/HSVtoRGB.vi"/>
			<Item Name="IRSensor(SubVI).vi" Type="VI" URL="../../SubVIs/IRSensor(SubVI).vi"/>
			<Item Name="LCD(SubVI).vi" Type="VI" URL="../../SubVIs/LCD(SubVI).vi"/>
			<Item Name="LEDStrip(SubVI).vi" Type="VI" URL="../../SubVIs/LEDStrip(SubVI).vi"/>
			<Item Name="MotorPWM(SubVI).vi" Type="VI" URL="../../SubVIs/MotorPWM(SubVI).vi"/>
			<Item Name="MotorPWM_B(SubVI).vi" Type="VI" URL="../../SubVIs/MotorPWM_B(SubVI).vi"/>
			<Item Name="motorRPM(SubVI).vi" Type="VI" URL="../../SubVIs/motorRPM(SubVI).vi"/>
			<Item Name="motorRPS(SubVI).vi" Type="VI" URL="../../SubVIs/motorRPS(SubVI).vi"/>
			<Item Name="RGBtoHSV.vi" Type="VI" URL="../../SubVIs/RGBtoHSV.vi"/>
			<Item Name="sevensegment(SubVI).vi" Type="VI" URL="../../SubVIs/sevensegment(SubVI).vi"/>
		</Item>
		<Item Name="buzzerTest.vi" Type="VI" URL="../buzzerTest.vi"/>
		<Item Name="calibrateEncoder.vi" Type="VI" URL="../calibrateEncoder.vi"/>
		<Item Name="encoderposition.ctl" Type="VI" URL="../encoderposition.ctl"/>
		<Item Name="HSVCycle.vi" Type="VI" URL="../../SubVIs/HSVCycle.vi"/>
		<Item Name="IRCalibration.vi" Type="VI" URL="../IRCalibration.vi"/>
		<Item Name="motorTest.vi" Type="VI" URL="../motorTest.vi"/>
